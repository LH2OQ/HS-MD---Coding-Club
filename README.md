...
- Erstellen von [Helferfunktionen](https://github.com/LH2OQ/HS-MD---Coding-Club/tree/main/helper) zum Lesen und Speichern von  HTML (Webseiten), Text und PDF (benötigt das Modul pypdf), sowie für Zugriff auf das LLM
- Erstellen [eines Skripts]([helper/eppo_first_aid.py](https://github.com/LH2OQ/HS-MD---Coding-Club/blob/main/helper/eppo_first_aid.py)),
  um den Inhalt der 'User-Instructions' und spezifische Links zur Datenbank von der Webseite auszulesen und dann eine spezifische Anfrage an das LLM zu stellen, welche weitere Schritte erläutern / vereinfachen helfen soll.
